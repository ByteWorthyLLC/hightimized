...
- [x] 00-08-PLAN.md — gh repo create + push + Discussions + Pages source (GATED, autonomous: false)
...
- [x] 01-03-PLAN.md — Phase 1 chargemaster.sqlite seed (single row for CPT 99213)
